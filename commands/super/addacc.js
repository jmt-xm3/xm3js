...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const dirPath = path.join(process.cwd(), 'commands', 'livery', 'acc', carName);
        ...
        try {
            ...
            await interaction.editReply(`ACC Livery added for ${carName}!`);
        } catch (error) {
            console.error('Error saving files:', error);
            await interaction.editReply('Failed to save ACC Livery files.');
        }
    }
};
